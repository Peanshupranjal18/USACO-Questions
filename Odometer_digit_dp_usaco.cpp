...
// Let dp[pos][k][under][started] where pos is the current position k is the counter to see if you have at least half of the same digit under is whether you have gone below the actual number and started is a boolean if you still have leading zeros.
